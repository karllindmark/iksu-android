...
public class DefaultMaterialHorizontalDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public DefaultMaterialHorizontalDivider(Context context, int orientation) {
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        final int stopIndex = parent.getChildCount() - 1;
